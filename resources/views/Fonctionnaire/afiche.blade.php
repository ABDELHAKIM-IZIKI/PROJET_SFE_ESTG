...
<div class="flex flex-col bg-gray-300 p-4 lg:px-40  ">
 ...
 <div class="flex flex-col  px-auto ">
       ...
       <div  class=" mt-2"> 
          <label class="font-medium text-black uppercase ">Categorie : </label><label>{{$materiel->categorie->nom ?? '---'}}</label>
       </div>
       <div  class=" mt-2"> 
       <label class="font-medium text-black uppercase ">Marque : </label><label>{{$materiel->marque->nom ?? '---'}}</label>
       <div>
...
@endif    
  ...
  @if($materiel->caracteristiques->isNotEmpty())
 ...
 <div class=" flex flex-col mt-2 lg:px-20  ">
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-700 mt-2 ">
        ...
        <tbody>
            @foreach ($materiel->caracteristiques as $item)
