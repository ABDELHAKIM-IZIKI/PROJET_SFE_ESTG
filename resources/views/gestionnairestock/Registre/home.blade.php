 ...
 <div class="mx-2 items-center ">
    <form method="get" action="{{route('Registre.search')}}" class="flex m-6  w-ful ">
        ...
        <div class="relative flex ">
            ...
            <input type="search" name="valeur" class=" w-full rounded-lg p-3 h-10 mx-2  border-gray-600 bg-white-400 placeholder-gray-400 text-black focus:ring-blue-500 focus:border-blue-500" placeholder="recherche par nom/prenom/tire/model/lieu" />
